...
\begin{figure}[H]
    \centering
        ...
        \multicolumn{3}{c|}{\textbf{discendente}}\\
        ...
        \hline
        x_5 &  & 
            \perp & [50, +\infty] & [50, +\infty] & 
            1st & 2nd & 3rd  \\
        \hline
        x_6 &  & 
            \perp & [100, +\infty] & [100, +\infty] & 
            1st & 2nd & 3rd  \\
        \hline
        \end{tabular}
        \]
...
\begin{tikzpicture}
  ...
  \node [rectangle, draw=black!25,  right=1cm of decide1] (return) {return \(x\);};
