...
Nella Figura \ref{fig:codiceEsempio1} si vede la traduzione di un semplice frammento di codice scritto in Python in un CFG. 
...
\end{center}
\end{minipage}
\caption{Programma senza cicli in Python e la sua Rappresentazione come CFG.}
...
\end{center}
\end{minipage}
\caption{Programma con cicli e comandi condizionali in Python e la sua rappresentazione come CFG.}
