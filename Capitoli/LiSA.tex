...
\setlength\itemsep{0.1em}
    ...
    \item un \texttt{TypeDomain} che è un \texttt{ValueDomain} che associa ad ogni variabile l'insieme dei possibili tipi a run-time delle variabili. Questa può essere usata a run-time per generare espressioni simboliche specifiche per i tipi delle variabili coinvolte nello statement;
\end{itemize}
