...
\title{Implementazione del decoupling della fase ascendente e discendente in LiSA}
\author{Matteo Boroni Grazioli}
...
\newcommand{\subTitle}{Implmentation of the decoupling of ascending and descending phases in LiSA} %Subtitle, usually the english version of the title
